...
impl PatternConstructor {
    ...
    ///
    /// [`PatternConstructor::DataConstructor`] and [`PatternConstructor::Record`]
    /// have non-zero arity based on their fields.
    ...
    ///
    /// [`PatternConstructor::DataConstructor`] and [`PatternConstructor::Record`]
    /// have fields corresponding to their arguments.
    ...
    ///
    /// For [`PatternConstructor::DataConstructor`] and [`PatternConstructor::Record`],
    /// this function overrides the fields. Otherwise, the fields must be empty
    /// as enforced by an assertion.
    ///
