    ...
    Q: ExternalQueries,
{
    ...
    let function_type = context.intern_function_chain(parameters.iter().copied(), result_type);
    Ok(function_type)
}
    ...
    Q: ExternalQueries,
{
    ...
    Ok(context.intern_function_chain(parameter_types.iter().copied(), result_type))
}
