...
#[rustfmt::skip]
#[test]
fn test_055_array_main() {
    let (engine, _) = tests_integration::load_compiler(std::path::Path::new("fixtures/checking/055_array"));
    let Some(id) = engine.module_file("Main") else {
        return;
    };
    let report = tests_integration::generated::basic::report_checked(&engine, id);
...
#[rustfmt::skip]
#[test]
fn test_056_record_main() {
    let (engine, _) = tests_integration::load_compiler(std::path::Path::new("fixtures/checking/056_record"));
    let Some(id) = engine.module_file("Main") else {
        return;
    };
    let report = tests_integration::generated::basic::report_checked(&engine, id);
...
#[rustfmt::skip]
#[test]
fn test_060_array_binder_main() {
    let (engine, _) = tests_integration::load_compiler(std::path::Path::new("fixtures/checking/060_array_binder"));
    let Some(id) = engine.module_file("Main") else {
        return;
    };
    let report = tests_integration::generated::basic::report_checked(&engine, id);
...
#[rustfmt::skip]
#[test]
fn test_061_record_binder_main() {
    let (engine, _) = tests_integration::load_compiler(std::path::Path::new("fixtures/checking/061_record_binder"));
    let Some(id) = engine.module_file("Main") else {
        return;
    };
    let report = tests_integration::generated::basic::report_checked(&engine, id);
...
#[rustfmt::skip]
#[test]
fn test_065_do_collector_main() {
    let (engine, _) = tests_integration::load_compiler(std::path::Path::new("fixtures/checking/065_do_collector"));
    let Some(id) = engine.module_file("Main") else {
        return;
    };
    let report = tests_integration::generated::basic::report_checked(&engine, id);
...
#[rustfmt::skip]
#[test]
fn test_066_ado_collector_main() {
    let (engine, _) = tests_integration::load_compiler(std::path::Path::new("fixtures/checking/066_ado_collector"));
    let Some(id) = engine.module_file("Main") else {
        return;
    };
    let report = tests_integration::generated::basic::report_checked(&engine, id);
...
#[rustfmt::skip]
#[test]
fn test_067_ado_let_main() {
    let (engine, _) = tests_integration::load_compiler(std::path::Path::new("fixtures/checking/067_ado_let"));
    let Some(id) = engine.module_file("Main") else {
        return;
    };
    let report = tests_integration::generated::basic::report_checked(&engine, id);
