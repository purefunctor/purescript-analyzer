module Prim.Int.Compare.Proofs where
...
-- Assertion helpers (using row types to capture the comparison)
...
-- Transitivity with symmetry (constraint direction differs from chain direction)
